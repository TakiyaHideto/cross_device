        ...
        protected void reduce(Text key, Iterable<Text> values,Context context)
            ...
            for (Text value: values){//
                ...
                for (String domainInfo: domainList){
                    ...
                    String timestamp = domainInfo.split(Properties.Base.CTRL_C,-1)[2];
                    String date = "";
                    String hour = "";
                    try{
            ...
            String valueResult;
            if (!domainInfoString.equals("") && !accumualteInfo.equals("")){
                valueResult = domainInfoString + Properties.Base.CTRL_B + accumualteInfo;
            } else if (!domainInfoString.equals("") && accumualteInfo.equals("")){
                valueResult = domainInfoString;
            } else if (domainInfoString.equals("") && !accumualteInfo.equals("")){
...
//        job.getConfiguration().set("mapreduce.map.java.opts ", "-Djava.net.preferIPv4Stack=true -Xmx3000000000");
        ...
        for (int i=0;i<1;i++) {
            CommUtil.addInputFileComm(job, fs, bidLog + "/" + currentData + "/WebDomain", TextInputFormat.class, SingleDayMapper.class);
