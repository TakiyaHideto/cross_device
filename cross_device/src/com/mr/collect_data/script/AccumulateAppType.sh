...
class_name=com.mr.collect_data.AccumulateAppType

output_path=/mroutput/cross_device/AccumulateAppType/log_date=$ONE_DAY_AGO
bid_log=/user/ads/mid/user/day/userExtract
accu_log=/mroutput/cross_device/AccumulateAppType/log_date=$TWO_DAY_AGO
